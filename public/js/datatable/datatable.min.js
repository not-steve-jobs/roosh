...
class DataTable {
    ...
    pagination() {
        ...
        for (let i = this.currPage - 2; i < this.currPage + 2; i++) {
            ...
            a.setAttribute("aria-controls", this.el.id),
                ...
                a.classList.add("btn"),
                (a.innerHTML = i),
                i == this.currPage ? a.setAttribute("aria-selected", !0) : (a.onclick = () => this.changePage(i)),
                e.appendChild(a);
        }
        if (this.currPage < t) {
            let i = document.createElement("button");
    ...
    toggleHead(e, t) {
        ...
        e.forEach((e) => {
            ...
            0 == i.length || "d" == i[0]
                ? (t.setAttribute("aria-sort", "ascending"), t.setAttribute("aria-label", `${t.innerText}: ${this.locale.ASC_ACTIVE}`), this.changeOrder(t.innerText, 1))
                : (t.setAttribute("aria-sort", "descending"), t.setAttribute("aria-label", `${t.innerText}: ${this.locale.DESC_ACTIVE}`), this.changeOrder(t.innerText, -1));
    }
    init() {
        ...
        r.forEach((e) => {
            e.setAttribute("tabindex", 0),
                ...
                e.setAttribute("aria-label", `${e.innerText}: ${this.locale.NOT_ACTIVE}`),
